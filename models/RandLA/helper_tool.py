...
class DataProcessing:
    ...
    def knn_search(support_pts, query_pts, k):
        """
        k nearest neighbor search: Takes each point from query_pts and looks for the k points in support_pts
        which are closest to the given query point.
        :param support_pts: points you have, (B*N1, 3)
        :param query_pts: points you want to know the neighbor index, (B*N2, 3)
